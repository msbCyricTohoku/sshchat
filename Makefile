#############################################################################
# Makefile for building: sshchat-v1
# Generated by qmake (3.1) (Qt 5.15.15)
# Project:  sshchat-v1.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile sshchat-v1.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = sshchat-v11.0.0
DISTDIR = /home/ben/main-works/sschat-v1/sshchat-v1/.tmp/sshchat-v11.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		sshchat-v1.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = sshchat-v1
DESTDIR       = 
TARGET        = sshchat-v1
...
sshchat-v1: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: sshchat-v1.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		sshchat-v1.pro
	$(QMAKE) -o Makefile sshchat-v1.pro
...
moc_mainwindow.cpp: mainwindow.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/ben/main-works/sschat-v1/sshchat-v1/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/ben/main-works/sschat-v1/sshchat-v1 -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/14.2.1 -I/usr/include/c++/14.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/14.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include-fixed -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/sshchat-v1/bin || mkdir -p $(INSTALL_ROOT)/opt/sshchat-v1/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/sshchat-v1/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/sshchat-v1/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/sshchat-v1/bin/ 
